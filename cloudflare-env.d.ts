/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareEnv cloudflare-env.d.ts` (hash: b2ca882780d1d210d19085a83790f697)
// Runtime types generated with workerd@1.20260603.1 2026-06-04 global_fetch_strictly_public,nodejs_compat
interface __BaseEnv_CloudflareEnv {
	RIG_DOWNLOADS: R2Bucket;
	IMAGES: ImagesBinding;
	ASSETS: Fetcher;
	NEXT_PUBLIC_SUPABASE_URL: string;
	NEXT_PUBLIC_SUPABASE_ANON_KEY: string;
	SUPABASE_SERVICE_ROLE_KEY: string;
	PCO_BASIC_TOKEN: string;
	PCO_PLAN_SCOPE_CAMPUS_NAME: string;
	GV_DRIVE_LAYOUT_ROOT_FOLDER_ID: string;
	GRG_TEMPLATE_FOLDER_ID: string;
	GRG_OUTPUT_FOLDER_ID: string;
	GRG_TEMPLATE_FOLDER_PATH: string;
	GRG_OUTPUT_FOLDER_PATH: string;
	GRG_TEMPLATE_TITLE: string;
	GRG_TEMPLATE_ID: string;
	GRG_OUTPUT_TITLE: string;
	GOOGLE_CLIENT_ID: string;
	GOOGLE_CLIENT_SECRET: string;
	GOOGLE_REDIRECT_URI: string;
	MESSAGING_SHEET_ID: string;
	MESSAGING_CALENDAR_ID: string;
	MESSAGING_ALERT_GROUP: string;
	PCO_OWNER_PERSON_ID: string;
	PCO_SERVICE_TYPE_ID: string;
	SLIDE_DECK_AGENT_TOKEN: string;
	GRAPEVINE_PREP_URL: string;
	PP_HOST: string;
	PP_PORT: string;
	PP_NETWORK_PORT: string;
	PP_TRANSPORT: string;
	PP_HTTPS: string;
	PP_REQUEST_TIMEOUT_MS: string;
	PP_ALLOW_WRITES: string;
	PP_APPLY_TIMEOUT_MS: string;
	PP_PLAYLISTS_FOLDER_ID: string;
	PP_NEW_FILES_FOLDER_ID: string;
	PP_TEMPLATE_PLAYLIST_NAME: string;
	PP_PLAYLIST_NAME_PREFIX: string;
	PP_PLATFORM_ORG_ID: string;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "NEXT_PUBLIC_SUPABASE_URL" | "NEXT_PUBLIC_SUPABASE_ANON_KEY" | "SUPABASE_SERVICE_ROLE_KEY" | "PCO_BASIC_TOKEN" | "PCO_PLAN_SCOPE_CAMPUS_NAME" | "GV_DRIVE_LAYOUT_ROOT_FOLDER_ID" | "GRG_TEMPLATE_FOLDER_ID" | "GRG_OUTPUT_FOLDER_ID" | "GRG_TEMPLATE_FOLDER_PATH" | "GRG_OUTPUT_FOLDER_PATH" | "GRG_TEMPLATE_TITLE" | "GRG_TEMPLATE_ID" | "GRG_OUTPUT_TITLE" | "GOOGLE_CLIENT_ID" | "GOOGLE_CLIENT_SECRET" | "GOOGLE_REDIRECT_URI" | "MESSAGING_SHEET_ID" | "MESSAGING_CALENDAR_ID" | "MESSAGING_ALERT_GROUP" | "PCO_OWNER_PERSON_ID" | "PCO_SERVICE_TYPE_ID" | "SLIDE_DECK_AGENT_TOKEN" | "GRAPEVINE_PREP_URL" | "PP_HOST" | "PP_PORT" | "PP_NETWORK_PORT" | "PP_TRANSPORT" | "PP_HTTPS" | "PP_REQUEST_TIMEOUT_MS" | "PP_ALLOW_WRITES" | "PP_APPLY_TIMEOUT_MS" | "PP_PLAYLISTS_FOLDER_ID" | "PP_NEW_FILES_FOLDER_ID" | "PP_TEMPLATE_PLAYLIST_NAME" | "PP_PLAYLIST_NAME_PREFIX" | "PP_PLATFORM_ORG_ID">> {}
}
